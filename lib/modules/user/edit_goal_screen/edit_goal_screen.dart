  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit,HomeStates>(
      ...
      builder: (context,state){
        ...
        return Scaffold(
            appBar: buildAppBar(title:AppLocalizations.of(context).translate("  ")),//'Edit Goal'),
                          ...
                          RadioListTile<activeList>(
                            ...
                            title:  Column(
                              ...
                              [
                                defaultBodyText(
                                  context,
                                  text: AppLocalizations.of(context).translate("  "),//'Not Active',
                                ),
                                SizedBox(
                                  height: 4,
                                ),
                                Text(
                                  AppLocalizations.of(context).translate("  "),//'Spend most of the day sitting (e.g., desk jop)',
                          ...
                          RadioListTile<activeList>(
                            ...
                            title:  Column(
                              ...
                              [
                                defaultBodyText(
                                  context,
                                  text: AppLocalizations.of(context).translate("  "),//'Lightly Active',
                                ),
                                SizedBox(
                                  height: 4,
                                ),
                                Text(
                                  AppLocalizations.of(context).translate("  "),//'Spend a good part of the day on your feet and train from 1 to 3 days (e.g., teacher, salesperson)',
                                  style: Theme.of(context).textTheme.caption,
                                ),
                              ],
                            ),
                          ...
                          RadioListTile<activeList>(
                            ...
                            title:  Column(
                              ...
                              [
                                ...
                                Text(
                                  AppLocalizations.of(context).translate("  "),//'Spend a good part of the day doing some physical activity and train from 3 to 5 days (e.g., food server, postal carrier).',
                                  style: Theme.of(context).textTheme.caption,
                                ),
                              ],
                            ),
                          ...
                          RadioListTile<activeList>(
                            ...
                            title:  Column(
                              ...
                              [
                                defaultBodyText(
                                  context,
                                  text: AppLocalizations.of(context).translate("  "),//'Very Active',
                                ),
                                SizedBox(
                                  height: 4,
                                ),
                                Text(
                                  AppLocalizations.of(context).translate("  "),//'Spend a good part of the day doing heavy physical activity train from 5 to 7 days (e.g., bike messenger, carpenter).',
                                  style: Theme.of(context).textTheme.caption,
                                ),
                              ],
                            ),
                          ...
                          RadioListTile<activeList>(
                            ...
                            title:  Column(
                              ...
                              [
                                ...
                                Text(
                                  AppLocalizations.of(context).translate("  "),//'Spend most of the day Hard training ',
                                  style: Theme.of(context).textTheme.caption,
                                ),
                              ],
                            ),
